...
This is a sample template for imageResize - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name imageresize --tail
```
...
```bash
aws cloudformation delete-stack --stack-name imageresize
```
